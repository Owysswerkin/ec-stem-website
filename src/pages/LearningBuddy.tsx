          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-block animate-fade-in">
                <svg width="103" height="15" viewBox="0 0 103 15" fill="currentColor" className="h-20 md:h-28 mx-auto drop-shadow-xl hover:scale-110 transition-transform duration-300">
