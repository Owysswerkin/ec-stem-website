...
const WhatsAppButton = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowBubble(scrollPercent >= 50);
    };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {/* Speech Bubble - only shows after 50% scroll */}
      {showBubble && (
        <div className="relative bg-white px-3 py-2 rounded-lg shadow-lg text-sm font-medium text-gray-700 animate-fade-in">
          Send us a message
