        ...
        <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden lg:flex items-center space-x-6 flex-1 justify-end">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-4 py-2 rounded-xl text-sm font-semibold text-sky-900 shadow-soft hover:shadow-warm transition-all duration-300 transform hover:scale-105 bg-gradient-to-r from-sky-100 to-blue-100 hover:from-sky-200 hover:to-blue-200"
              >
                {t('nav.staffLogin')}
              </a>
              <LanguageToggle />
